...
export interface Loan { id:string; vehicleId:string; driverId:string; requesterId:string; sectorId:string|null; status:LoanStatus; period:LoanPeriod; destination:string; purpose:string; checklistDone?:boolean; checklistRequired?:boolean; rejectionReason?:string; decidedBy?:string; decidedAt?:string }
